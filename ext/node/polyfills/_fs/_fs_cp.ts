...
import { CallbackWithError, makeCallback } from "ext:deno_node/_fs/_fs_common.ts";
...
export function cpSync(src: string | URL, dest: string | URL, options?: CopySyncOptions): void {
